...
var _ArrayPrototypeReduce = require("array.prototype.reduce");
...
function _wrapRegExp() {
  ...
  function buildGroups(result, re) {
    ...
    return (_Object$keys = Object.keys(g), Array.isArray(_Object$keys) ? _ArrayPrototypeReduce : Function.call.bind(_Object$keys.reduce))(_Object$keys, function (groups, name) {
      var i = g[name];
